...
<style>
  ...
  #afx-before-after,#afx-feed-sim,#afx-style-lab,#afx-why-studio,#afx-smart-order,#afx-promo-lab,#afx-faq,#aurafx-reviews{content-visibility:auto;contain-intrinsic-size:auto 760px}
...
<style>
  ...
  /* 1. Marketplace simulator — real portfolio in a simulated feed */
  #afx-feed-sim{position:relative;padding:100px 0 110px;color:#fff;background:linear-gradient(180deg,rgba(8,4,14,0),rgba(30,9,53,.38),rgba(8,4,14,0));overflow:hidden}
  #afx-feed-sim:before{content:"";position:absolute;width:430px;height:430px;border-radius:50%;right:-170px;top:70px;background:rgba(164,73,255,.13);filter:blur(95px);pointer-events:none}
  .afx-feed-shell{display:grid;grid-template-columns:.78fr 1.22fr;gap:22px;margin-top:34px;align-items:stretch}
  .afx-feed-copy{padding:28px;display:flex;flex-direction:column;justify-content:space-between;min-height:560px}
  .afx-feed-copy h3{margin:0;font-size:28px;letter-spacing:-.035em}.afx-feed-copy p{margin:10px 0 0;color:#94899f;line-height:1.65;font-size:13px}
  .afx-feed-stat{display:grid;gap:10px;margin-top:24px}.afx-feed-stat>div{display:grid;grid-template-columns:38px 1fr;gap:11px;align-items:center;padding:12px;border-radius:16px;background:rgba(255,255,255,.025);border:1px solid rgba(255,255,255,.055)}
  .afx-feed-stat i{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:rgba(168,85,247,.13);color:#c995ff;font-style:normal;font-weight:900;font-size:10px}.afx-feed-stat b{display:block;font-size:12px}.afx-feed-stat span{display:block;margin-top:3px;color:#7f7588;font-size:10px;line-height:1.45}
  .afx-feed-controls{display:grid;gap:10px;margin-top:24px}.afx-feed-btn{border:1px solid rgba(255,255,255,.1);border-radius:16px;padding:13px 15px;background:rgba(255,255,255,.04);color:#efe8f5;font:850 12px/1 inherit;cursor:pointer;text-align:left;transition:.2s}.afx-feed-btn.primary{background:linear-gradient(135deg,#ad4fff,#6537e7);border-color:transparent;box-shadow:0 12px 32px rgba(125,52,232,.22)}.afx-feed-btn:active{transform:scale(.985)}
  .afx-feed-stage{padding:18px;min-height:560px;position:relative}
  .afx-feed-topbar{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:2px 2px 14px}.afx-feed-topbar b{font-size:13px}.afx-feed-topbar span{font-size:10px;color:#796f83}.afx-feed-live{display:inline-flex!important;align-items:center;gap:6px!important;color:#9bf5ff!important}.afx-feed-live:before{content:"";width:7px;height:7px;border-radius:50%;background:#58e8ff;box-shadow:0 0 12px rgba(88,232,255,.7)}
  .afx-feed-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;position:relative}
  .afx-feed-item{position:relative;aspect-ratio:4/5;border-radius:18px;overflow:hidden;background:linear-gradient(145deg,#f0eef2,#c9c5cc);border:1px solid rgba(255,255,255,.08);box-shadow:0 12px 28px rgba(0,0,0,.18);transition:.28s cubic-bezier(.2,.75,.2,1)}
  .afx-feed-item:before{content:"";position:absolute;left:18%;right:18%;top:14%;height:47%;border-radius:18px;background:linear-gradient(145deg,#d9d6db,#a9a5ac);box-shadow:0 14px 24px rgba(0,0,0,.08)}
  .afx-feed-item:after{content:"";position:absolute;left:11%;right:11%;bottom:10%;height:12%;border-radius:10px;background:linear-gradient(180deg,rgba(33,28,37,.18),rgba(33,28,37,.08));box-shadow:0 -22px 0 rgba(33,28,37,.08)}
  .afx-feed-item:nth-child(2n){background:linear-gradient(145deg,#eceff1,#c3c8cc)}.afx-feed-item:nth-child(3n){background:linear-gradient(145deg,#eee9e4,#c8c0b6)}
  .afx-feed-feature{background:#0b0612!important;border-color:rgba(177,92,255,.42);box-shadow:0 18px 44px rgba(95,36,178,.26),0 0 0 1px rgba(104,229,255,.08) inset;transform:translateY(-2px)}
  .afx-feed-feature:before,.afx-feed-feature:after{display:none}.afx-feed-feature img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;display:block;transition:.3s}.afx-feed-feature .afx-feed-badge{position:absolute;z-index:3;left:8px;top:8px;padding:6px 8px;border-radius:999px;background:rgba(9,5,15,.78);border:1px solid rgba(255,255,255,.12);backdrop-filter:blur(8px);font-size:8px;font-weight:900;letter-spacing:.08em;text-transform:uppercase}
  .afx-feed-feature .afx-feed-ring{position:absolute;inset:0;border-radius:inherit;box-shadow:inset 0 0 0 2px rgba(98,231,255,0);transition:.28s;pointer-events:none}.afx-feed-stage.scanning .afx-feed-feature{transform:translateY(-8px) scale(1.035);z-index:4;box-shadow:0 26px 70px rgba(113,49,217,.36),0 0 44px rgba(91,225,255,.12)}.afx-feed-stage.scanning .afx-feed-feature .afx-feed-ring{box-shadow:inset 0 0 0 2px rgba(98,231,255,.78),0 0 28px rgba(98,231,255,.2)}.afx-feed-stage.scanning .afx-feed-item:not(.afx-feed-feature){filter:grayscale(.86) brightness(.72);opacity:.68;transform:scale(.97)}
  .afx-feed-scanline{position:absolute;z-index:6;left:18px;right:18px;height:2px;top:56px;background:linear-gradient(90deg,transparent,#6eeaff,transparent);opacity:0;box-shadow:0 0 18px rgba(110,234,255,.9);pointer-events:none}.afx-feed-stage.scanning .afx-feed-scanline{opacity:1;animation:afxFeedScan 1.6s ease-in-out 1}@keyframes afxFeedScan{0%{transform:translateY(0)}100%{transform:translateY(470px)}}
  .afx-feed-picker{display:flex;gap:8px;overflow-x:auto;padding:14px 2px 2px;scrollbar-width:none}.afx-feed-picker::-webkit-scrollbar{display:none}.afx-feed-pick{width:62px;height:78px;flex:0 0 62px;border:1px solid rgba(255,255,255,.09);border-radius:13px;background-position:center;background-size:cover;cursor:pointer;opacity:.58;transition:.2s}.afx-feed-pick.active{opacity:1;border-color:#a655ff;box-shadow:0 0 0 2px rgba(166,85,255,.15),0 10px 24px rgba(0,0,0,.22);transform:translateY(-2px)}
  .afx-feed-note{margin-top:10px;color:#736a7d;font-size:10px;line-height:1.55}.afx-feed-note b{color:#bfaecb}
  @media(max-width:850px){.afx-feed-shell{grid-template-columns:1fr}.afx-feed-copy{min-height:0}.afx-feed-stage{min-height:0}.afx-feed-grid{grid-template-columns:repeat(2,1fr)}.afx-feed-item{border-radius:16px}.afx-feed-stage.scanning .afx-feed-feature{transform:translateY(-5px) scale(1.025)}@keyframes afxFeedScan{0%{transform:translateY(0)}100%{transform:translateY(620px)}}}
  @media(max-width:560px){#afx-feed-sim{padding:72px 0 82px}.afx-feed-copy,.afx-feed-stage{padding:18px}.afx-feed-copy h3{font-size:24px}.afx-feed-grid{gap:8px}.afx-feed-item{border-radius:14px}.afx-feed-pick{width:54px;height:68px;flex-basis:54px}}
  ...
  .afx-radar{position:relative;min-height:390px;padding:18px;background:radial-gradient(circle at 82% 12%,rgba(94,229,255,.12),transparent 25%),radial-gradient(circle at 12% 86%,rgba(176,77,255,.18),transparent 30%),linear-gradient(145deg,#0b0711,#1e0b35);overflow:hidden}
  .afx-radar-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;position:relative;z-index:3}.afx-radar-head small{display:block;color:#78ecff;font:900 9px/1 system-ui,sans-serif;letter-spacing:.17em;text-transform:uppercase}.afx-radar-head b{display:block;margin-top:7px;font-size:18px;letter-spacing:-.025em}.afx-radar-count{font-size:10px!important;color:#8b7f95!important;letter-spacing:.08em}
  .afx-radar-visual{position:absolute;left:18px;right:18px;top:72px;bottom:62px;border-radius:21px;overflow:hidden;border:1px solid rgba(255,255,255,.09);background:#0b0710;box-shadow:0 24px 55px rgba(0,0,0,.32)}
  .afx-radar-visual:before{content:"";position:absolute;inset:0;z-index:2;pointer-events:none;background:linear-gradient(180deg,transparent 54%,rgba(7,4,12,.62));opacity:.55}
  .afx-radar-visual img{width:100%;height:100%;object-fit:cover;display:block;transition:opacity .22s ease,transform .42s cubic-bezier(.2,.75,.2,1);transform:scale(1.015)}
  .afx-radar:hover .afx-radar-visual img{transform:scale(1.04)}
  .afx-radar-tag{position:absolute;left:12px;bottom:12px;z-index:4;padding:8px 10px;border-radius:999px;background:rgba(8,5,14,.76);border:1px solid rgba(255,255,255,.1);backdrop-filter:blur(8px);font-size:9px;font-weight:850;color:#eee7f5}
  .afx-radar-controls{position:absolute;left:18px;right:18px;bottom:16px;display:flex;align-items:center;justify-content:space-between;gap:10px;z-index:4}.afx-radar-nav{display:flex;gap:7px}.afx-radar-nav button{width:36px;height:36px;border-radius:12px;border:1px solid rgba(255,255,255,.09);background:rgba(255,255,255,.04);color:#fff;font:900 18px/1 system-ui;cursor:pointer}.afx-radar-nav button:active{transform:scale(.96)}
  .afx-radar-dots{display:flex;gap:5px;flex:1;justify-content:flex-end}.afx-radar-dots button{width:18px;height:4px;border:0;border-radius:99px;background:#493d55;padding:0;cursor:pointer;transition:.2s}.afx-radar-dots button.active{width:34px;background:linear-gradient(90deg,#69e9ff,#a955ff);box-shadow:0 0 12px rgba(105,233,255,.22)}
  @media(max-width:560px){.afx-radar{min-height:440px}.afx-radar-visual{top:76px;bottom:64px}}
  ...
  @media(max-width:900px){.afx-style-grid,.afx-bts-grid,.afx-order-shell{grid-template-columns:1fr}.afx-why-grid{grid-template-columns:1fr 1fr}}
  @media(max-width:560px){.afx-wow-wrap{width:min(100% - 28px,1160px)}#afx-feed-sim,#afx-style-lab,#afx-why-studio,#afx-smart-order{padding:72px 0}.afx-wow-title{font-size:44px}.afx-why-grid,.afx-order-options{grid-template-columns:1fr}.afx-style-preview{min-height:470px;padding:10px}.afx-style-canvas{min-height:450px}.afx-order-main,.afx-order-aside{padding:20px}}
</style>
<div id="afx-pointer-glow" aria-hidden="true"></div>

<section id="afx-feed-sim" aria-labelledby="afx-feed-title">
  <div class="afx-wow-wrap">
    <div class="afx-wow-kicker"><i></i> Marketplace Simulator</div>
    <h2 class="afx-wow-title" id="afx-feed-title">Посмотри карточку <em>прямо в выдаче</em></h2>
    <p class="afx-wow-sub">Не обещания и не нарисованные проценты. Просто визуальный тест: как реальный кейс AuraFX ощущается среди нейтральных карточек в ленте.</p>
    <div class="afx-feed-shell">
      <aside class="afx-wow-card afx-feed-copy">
        <div><h3>Тест внимания</h3><p>Выбери реальный кейс из портфолио и включи режим сканирования. Мы специально сделали соседние карточки нейтральными, чтобы оценивать только визуальную заметность.</p>
          <div class="afx-feed-stat">
            <div><i>01</i><div><b>Реальный кейс</b><span>В центре используется настоящая обложка из портфолио AuraFX.</span></div></div>
            <div><i>02</i><div><b>Без фейковых метрик</b><span>Симулятор показывает композицию и контраст, а не придумывает продажи.</span></div></div>
            <div><i>03</i><div><b>Работает пальцем</b><span>Выбирай кейсы и запускай тест прямо с телефона.</span></div></div>
          </div>
        </div>
        <div class="afx-feed-controls"><button class="afx-feed-btn primary" id="afx-feed-scan" type="button">◉ Запустить тест внимания</button><button class="afx-feed-btn" id="afx-feed-shuffle" type="button">↻ Перемешать выдачу</button></div>
      </aside>
      <div class="afx-wow-card afx-feed-stage" id="afx-feed-stage">
        <div class="afx-feed-topbar"><div><b>Симулятор выдачи</b><span> · визуальный макет</span></div><span class="afx-feed-live">LIVE VIEW</span></div>
        <div class="afx-feed-scanline"></div>
        <div class="afx-feed-grid" id="afx-feed-grid">
          <div class="afx-feed-item"></div><div class="afx-feed-item"></div><div class="afx-feed-item"></div>
          <div class="afx-feed-item afx-feed-feature" id="afx-feed-feature"><img id="afx-feed-image" alt="Кейс AuraFX"><span class="afx-feed-badge">AuraFX case</span><span class="afx-feed-ring"></span></div>
          <div class="afx-feed-item"></div><div class="afx-feed-item"></div><div class="afx-feed-item"></div><div class="afx-feed-item"></div><div class="afx-feed-item"></div>
        </div>
        <div class="afx-feed-picker" id="afx-feed-picker" aria-label="Выбрать кейс AuraFX"></div>
        <div class="afx-feed-note"><b>Важно:</b> это не копия конкретного маркетплейса и не обещание роста продаж — это интерактивная демонстрация визуальной подачи.</div>
      </div>
    </div>
  </div>
</section>
...
(function(){
  ...
  function placePremium(){var anchor=document.getElementById('afx-before-after');if(!anchor||!anchor.parentNode)return;var parent=anchor.parentNode,ref=anchor.nextSibling;['afx-feed-sim','afx-style-lab','afx-why-studio','afx-smart-order'].forEach(function(id){var el=document.getElementById(id);if(el&&el.parentNode===parent)parent.insertBefore(el,ref)});}
  setTimeout(placePremium,350);setTimeout(placePremium,1050);setTimeout(placePremium,1800);

  /* Marketplace simulator: uses real case covers already present on the page. */
  var feedStage=document.getElementById('afx-feed-stage'),feedFeature=document.getElementById('afx-feed-feature'),feedImage=document.getElementById('afx-feed-image'),feedPicker=document.getElementById('afx-feed-picker'),feedScan=document.getElementById('afx-feed-scan'),feedShuffle=document.getElementById('afx-feed-shuffle'),feedGrid=document.getElementById('afx-feed-grid');
  function feedSrc(card){var img=card&&card.querySelector('img');return img&&(img.currentSrc||img.src)||''}
  function feedName(card,i){var h=card&&card.querySelector('h2,h3,h4,strong');var t=String(h&&h.textContent||'').replace(/\s+/g,' ').trim();return t||('Кейс '+(i+1))}
  var feedItems=[],feedActive=0,feedBuilt=false;
  function collectFeed(){
    var cards=[].slice.call(document.querySelectorAll('.afx-case-ready')).filter(function(c){return !!feedSrc(c)}).slice(0,8);
    if(!cards.length)return false;
    feedItems=cards.map(function(c,i){return {src:feedSrc(c),name:feedName(c,i)}});
    return true;
  }
  function renderFeedPicker(){
    if(!feedPicker)return;feedPicker.innerHTML='';
    feedItems.forEach(function(item,i){var b=document.createElement('button');b.type='button';b.className='afx-feed-pick'+(i===feedActive?' active':'');b.style.backgroundImage='url('+JSON.stringify(item.src)+')';b.title=item.name;b.setAttribute('aria-label','Показать '+item.name);b.addEventListener('click',function(){feedActive=i;renderFeed()});feedPicker.appendChild(b)});
  }
  function renderFeed(){
    if(!feedItems.length||!feedImage)return;
    var item=feedItems[feedActive%feedItems.length];feedImage.src=item.src;feedImage.alt=item.name+' — кейс AuraFX';
    [].slice.call(feedPicker&&feedPicker.children||[]).forEach(function(b,i){b.classList.toggle('active',i===feedActive)});
    if(feedStage){feedStage.classList.remove('scanning');void feedStage.offsetWidth}
  }
  function buildFeed(){if(feedBuilt)return true;if(!collectFeed())return false;feedBuilt=true;renderFeedPicker();renderFeed();return true}
  if(feedScan)feedScan.addEventListener('click',function(){if(!feedStage)return;feedStage.classList.remove('scanning');void feedStage.offsetWidth;feedStage.classList.add('scanning');setTimeout(function(){feedStage&&feedStage.classList.remove('scanning')},1750)});
  if(feedShuffle)feedShuffle.addEventListener('click',function(){if(feedItems.length>1){feedActive=(feedActive+1+Math.floor(Math.random()*(feedItems.length-1)))%feedItems.length;renderFeed()}if(feedGrid){var nodes=[].slice.call(feedGrid.children);for(var i=nodes.length-1;i>0;i--){var j=Math.floor(Math.random()*(i+1));feedGrid.appendChild(nodes[j]);nodes.splice(j,1)}}});
  var feedTries=0,feedTimer=setInterval(function(){feedTries++;if(buildFeed()||feedTries>25)clearInterval(feedTimer)},220);
  ...
  var styles={premium:{head:'ЗВУК<br>БЕЗ ЛИШНЕГО',kick:'AuraFX · Premium',chips:['Комфорт','Чистый фокус','Premium'],hint:'Подходит для товаров, где важны ощущение качества, аккуратная подача и доверие.'},minimal:{head:'ЧИСТАЯ<br>ПОДАЧА',kick:'AuraFX · Minimal',chips:['Воздух','Форма','Функция'],hint:'Хороший выбор, когда сам продукт уже сильный и ему не нужен визуальный шум.'},market:{head:'ЗАБИРАЙ<br>ВНИМАНИЕ',kick:'AuraFX · Marketplace',chips:['Акцент','УТП','Быстро читается'],hint:'Для конкурентной выдачи, где карточка должна заметно выделиться на маленьком экране.'}};
  ...
  /* Case Radar: real portfolio browser, no fake transformation. */
  var radar=document.getElementById('afx-case-radar'),radarImg=document.getElementById('afx-radar-img'),radarTitle=document.getElementById('afx-radar-title'),radarCount=document.getElementById('afx-radar-count'),radarTag=document.getElementById('afx-radar-tag'),radarDots=document.getElementById('afx-radar-dots'),radarPrev=document.getElementById('afx-radar-prev'),radarNext=document.getElementById('afx-radar-next'),radarItems=[],radarIndex=0,radarTimer=0;
  function radarSrc(card){var img=card&&card.querySelector('img');return img&&(img.currentSrc||img.src)||''}
  function radarName(card,i){var h=card&&card.querySelector('h2,h3,h4,strong');var t=String(h&&h.textContent||'').replace(/\s+/g,' ').trim();return t||('Кейс '+(i+1))}
  function collectRadar(){var cards=[].slice.call(document.querySelectorAll('.afx-case-ready')).filter(function(c){return !!radarSrc(c)}).slice(0,6);if(!cards.length)return false;radarItems=cards.map(function(c,i){return {src:radarSrc(c),name:radarName(c,i)}});return true}
  function radarRender(){if(!radarItems.length||!radarImg)return;var item=radarItems[radarIndex%radarItems.length];radarImg.style.opacity='.18';setTimeout(function(){radarImg.src=item.src;radarImg.alt=item.name+' — кейс AuraFX';radarImg.style.opacity='1'},90);if(radarTitle)radarTitle.textContent=item.name;if(radarCount)radarCount.textContent=String(radarIndex+1).padStart(2,'0')+' / '+String(radarItems.length).padStart(2,'0');if(radarTag)radarTag.textContent='AuraFX · '+(radarIndex===0?'featured':'portfolio');[].slice.call(radarDots&&radarDots.children||[]).forEach(function(d,i){d.classList.toggle('active',i===radarIndex)})}
  function radarBuild(){if(!collectRadar())return false;if(radarDots){radarDots.innerHTML='';radarItems.forEach(function(_,i){var d=document.createElement('button');d.type='button';d.setAttribute('aria-label','Кейс '+(i+1));d.addEventListener('click',function(){radarIndex=i;radarRender()});radarDots.appendChild(d)})}radarRender();return true}
  function radarMove(dir){if(!radarItems.length)return;radarIndex=(radarIndex+dir+radarItems.length)%radarItems.length;radarRender()}
  if(radarPrev)radarPrev.addEventListener('click',function(){radarMove(-1)});if(radarNext)radarNext.addEventListener('click',function(){radarMove(1)});
  var radarTries=0,radarBuildTimer=setInterval(function(){radarTries++;if(radarBuild()||radarTries>25)clearInterval(radarBuildTimer)},220);
  if(radar&&'IntersectionObserver' in window){new IntersectionObserver(function(es){if(es[0].isIntersecting&&!radarTimer)radarTimer=setInterval(function(){radarMove(1)},4200);else if(!es[0].isIntersecting&&radarTimer){clearInterval(radarTimer);radarTimer=0}},{threshold:.25}).observe(radar)}
