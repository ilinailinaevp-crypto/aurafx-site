...
<style>
  #afx-account-shell{position:fixed;top:14px;right:14px;z-index:9998;display:flex;align-items:center;gap:7px;font-family:Inter,system-ui,-apple-system,Segoe UI,Roboto,sans-serif}
