...
(function(){
  ...
  function renderReel(){if(reel)reel.dataset.scene=String(scene);scenes.forEach(function(x,i){x.classList.toggle('active',i===scene)});dots.forEach(function(x,i){x.classList.toggle('active',i===scene)})} function advance(){scene=(scene+1)%scenes.length;renderReel()} renderReel();
