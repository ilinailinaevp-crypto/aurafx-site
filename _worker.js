...
<style>
  ...
  .afx-transform-design{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;z-index:6;opacity:0;transform:scale(1.035);filter:saturate(1.04) contrast(1.03);will-change:opacity,transform;pointer-events:none}
  ...
  .afx-reel img{position:absolute;transition:.65s cubic-bezier(.2,.75,.2,1);z-index:2}
  .afx-reel-raw{width:64%;height:64%;left:18%;top:20%;object-fit:contain;filter:drop-shadow(0 18px 28px rgba(0,0,0,.18))}
  .afx-reel-final{inset:7%;width:86%;height:86%;object-fit:cover;border-radius:18px;opacity:0;transform:scale(.94);box-shadow:0 24px 70px rgba(0,0,0,.36)}
  .afx-reel:before{content:"";position:absolute;inset:0;z-index:1;opacity:0;transition:.6s ease;background:radial-gradient(circle at 72% 22%,rgba(96,229,255,.30),transparent 28%),radial-gradient(circle at 22% 78%,rgba(176,74,255,.42),transparent 36%),linear-gradient(145deg,#08050e,#24103d);pointer-events:none}
  .afx-reel[data-scene='1']:before,.afx-reel[data-scene='2']:before{opacity:1}
  .afx-reel[data-scene='1'] .afx-reel-raw{width:72%;height:72%;left:14%;top:15%;transform:translateY(-2%) scale(1.02);filter:drop-shadow(0 28px 34px rgba(0,0,0,.36))}
  .afx-reel[data-scene='2'] .afx-reel-raw{opacity:.25;transform:scale(.92)}
  .afx-reel[data-scene='2'] .afx-reel-final{opacity:.68;transform:scale(.975)}
  .afx-reel[data-scene='3'] .afx-reel-raw{opacity:0;transform:scale(.88)}
  .afx-reel[data-scene='3'] .afx-reel-final{opacity:1;transform:scale(1)}
  .afx-reel-build{position:absolute;inset:0;z-index:2;pointer-events:none;opacity:0;transition:.55s ease}
  .afx-reel-build-grid{position:absolute;inset:8%;border:1px solid rgba(110,229,255,.18);border-radius:22px;opacity:0;transform:scale(.96);transition:.5s ease;box-shadow:inset 0 0 0 1px rgba(181,85,255,.08)}
  .afx-reel-build-grid:before,.afx-reel-build-grid:after{content:'';position:absolute;background:rgba(255,255,255,.08)}
  .afx-reel-build-grid:before{left:34%;top:0;bottom:0;width:1px}.afx-reel-build-grid:after{top:64%;left:0;right:0;height:1px}
  .afx-reel-build-copy{position:absolute;left:8%;top:10%;z-index:3;opacity:0;transform:translateY(12px);transition:.5s ease}
  .afx-reel-build-copy small{display:block;color:#8defff;font:900 9px/1 system-ui,sans-serif;letter-spacing:.16em;text-transform:uppercase;margin-bottom:6px}
  .afx-reel-build-copy b{display:block;color:#fff;font:950 clamp(38px,7vw,68px)/.82 system-ui,sans-serif;letter-spacing:-.065em;text-shadow:0 10px 30px rgba(0,0,0,.35)}
  .afx-reel-build-specs{position:absolute;left:8%;bottom:18%;display:grid;gap:7px;z-index:3;opacity:0;transform:translateY(12px);transition:.5s ease}
  .afx-reel-build-specs span{display:inline-flex;align-items:center;gap:7px;color:#f3eff7;font:850 9px/1.2 system-ui,sans-serif}.afx-reel-build-specs span:before{content:'•';color:#70e9ff}
  .afx-reel-build-badge{position:absolute;right:8%;bottom:9%;padding:8px 10px;border-radius:12px;border:1px solid rgba(112,233,255,.3);background:rgba(8,6,15,.72);color:#fff;font:900 9px/1.15 system-ui,sans-serif;letter-spacing:.06em;opacity:0;transform:translateY(10px);transition:.5s ease}
  .afx-reel[data-scene='1'] .afx-reel-build,.afx-reel[data-scene='2'] .afx-reel-build{opacity:1}
  .afx-reel[data-scene='1'] .afx-reel-build-grid,.afx-reel[data-scene='2'] .afx-reel-build-grid{opacity:1;transform:scale(1)}
  .afx-reel[data-scene='2'] .afx-reel-build-copy,.afx-reel[data-scene='2'] .afx-reel-build-specs,.afx-reel[data-scene='2'] .afx-reel-build-badge{opacity:1;transform:none}
  .afx-reel-scene{position:absolute;inset:0;padding:26px;z-index:4;opacity:0;transition:.5s ease;pointer-events:none} .afx-reel-scene.active{opacity:1} .afx-reel-scene small{font-size:9px;font-weight:900;letter-spacing:.16em;text-transform:uppercase;color:#7beaff} .afx-reel-scene b{position:absolute;left:26px;right:26px;bottom:24px;font-size:32px;line-height:.95;letter-spacing:-.04em}
...
(function(){
  ...
  var section=document.getElementById('afx-wow-transform'),stage=document.getElementById('afx-transform-stage'),stageWrap=stage&&stage.closest('.afx-transform-stage-wrap'),bg=document.getElementById('afx-transform-bg'),lines=document.getElementById('afx-transform-lines'),copyfx=document.getElementById('afx-transform-copyfx'),specs=document.getElementById('afx-transform-specs'),bar=document.getElementById('afx-transform-bar'),product=stage&&stage.querySelector('.afx-transform-product'),design=stage&&stage.querySelector('.afx-transform-design'),transformSteps=[].slice.call(document.querySelectorAll('#afx-wow-transform .afx-transform-step'));
  ...
  function paintTransform(){
    ...
    var bgp=clamp(p/.28),titlep=clamp((p-.24)/.28),specp=clamp((p-.50)/.24),designp=clamp((p-.68)/.24);
    if(bg)bg.style.opacity=String(bgp*(1-designp*.7));
    ...
    if(copyfx){copyfx.style.opacity=String(titlep*(1-designp));copyfx.style.transform='translateY('+(18-18*titlep).toFixed(1)+'px) scale('+(0.97+0.03*titlep).toFixed(3)+')'}
    if(specs){specs.style.opacity=String(specp*(1-designp));specs.style.transform='translateY('+(16-16*specp).toFixed(1)+'px)'}
    if(design){design.style.opacity=String(designp);design.style.transform='scale('+(1.035-.035*designp).toFixed(3)+')'}
    if(product)product.style.opacity=String(1-clamp((p-.70)/.22));
  ...
  var reelRaw=reel&&reel.querySelector('.afx-reel-raw'),reelFinal=reel&&reel.querySelector('.afx-reel-final');
  function renderReel(){
    if(reel)reel.dataset.scene=String(scene);
    /* Explicit image states: 0-2 always use the plain source; only 3 shows the final card. */
    if(reelRaw){reelRaw.src=PRODUCT_SRC;reelRaw.style.opacity=scene===3?'0':'1';reelRaw.style.visibility=scene===3?'hidden':'visible'}
    if(reelFinal){reelFinal.src=DESIGN_SRC;reelFinal.style.opacity=scene===3?'1':'0';reelFinal.style.visibility=scene===3?'visible':'hidden'}
    if(reelRaw){
      if(scene===0){reelRaw.style.width='64%';reelRaw.style.height='64%';reelRaw.style.left='18%';reelRaw.style.top='20%';reelRaw.style.transform='none'}
      else if(scene===1){reelRaw.style.width='72%';reelRaw.style.height='72%';reelRaw.style.left='14%';reelRaw.style.top='15%';reelRaw.style.transform='translateY(-2%) scale(1.02)'}
      else if(scene===2){reelRaw.style.width='68%';reelRaw.style.height='68%';reelRaw.style.left='28%';reelRaw.style.top='18%';reelRaw.style.transform='scale(.98)'}
    }
    scenes.forEach(function(x,i){x.classList.toggle('active',i===scene)});dots.forEach(function(x,i){x.classList.toggle('active',i===scene)})
  } function advance(){scene=(scene+1)%scenes.length;renderReel()} renderReel();
